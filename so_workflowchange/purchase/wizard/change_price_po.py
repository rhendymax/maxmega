...
class change_price_po(osv.osv_memory):
    _name = 'change.price.po'
    ...
    def default_get(self, cr, uid, fields, context=None):
        ...
        res = super(change_price_po, self).default_get(cr, uid, fields, context=context)
    ...
    def change_price(self, cr, uid, ids, context=None):
        ...
        for obj in self.browse(cr, uid, ids, context=context):
            purchase_order_line_obj.write(cr, uid, obj.po_line_id.id, {'price_unit': obj.price_unit}, context=context)
