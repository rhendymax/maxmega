...
class param_payment_deposit_bank_report(osv.osv_memory):
    _name = "param.payment.deposit.bank.report"
    _description = "Param Payment Deposit Bank Report"
    ...
    _columns = {
        ...
        'partner_ids' :fields.many2many('res.partner', 'report_payment_deposit_supplier_rel', 'report_id', 'partner_id', 'Supplier', domain=[('supplier','=',True)]),
        ...
        'journal_ids' :fields.many2many('account.journal', 'report_payment_deposit_journal_rel', 'report_id', 'journal_id', 'Bank', domain=[('type','in',('bank', 'cash'))]),
    }
    ...
    def create_vat(self, cr, uid, ids, context=None):
        ...
        datas['model'] = 'param.payment.deposit.report'
...
param_payment_deposit_bank_report()
