...
import time
class param_oustanding_receipt_deposit_report(osv.osv_memory):
    _name = 'param.oustanding.receipt.deposit.report'
    _description = 'Param Oustanding Receipt Deposit Report '
    _columns = {
        ...
        'partner_ids' :fields.many2many('res.partner', 'report_oustanding_receivable_deposit_customer_rel', 'report_id', 'partner_id', 'Customer', domain=[('customer','=',True)]),
...
#         'period_input_from': fields.char('Period From', size=128),
        ...
        'journal_ids' :fields.many2many('account.journal', 'report_oustanding_receivable_deposit_journal_rel', 'report_id', 'journal_id', 'Bank', domain=[('type','in',('bank','cash'))]),
    }
    ...
    def create_vat(self, cr, uid, ids, context=None):
        ...
        datas['model'] = 'param.oustanding.receipt.deposit.report'
...
param_oustanding_receipt_deposit_report()
