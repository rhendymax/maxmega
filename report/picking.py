...
class maxmega_packing_order(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(maxmega_packing_order, self).__init__(cr, uid, name, context=context)
        self.localcontext.update({
...
#                             <tr>
#                                 <td>
#                                     <para style="terp_default_9_Italic_Bold">PACKING LIST</para>
#                                 </td>
#                                 <td>
#                                 </td>
#                             </tr>
...
#     <template pageSize="(21.59cm, 27.94cm)" title="Packing List" author="Yanto Chen" allowSplitting="20">
...
# maxmega_packing_order('report.max.stock.picking.list', 'stock.picking','','')

report_sxw.report_sxw(
    'report.max.stock.picking.list',
    'stock.picking',
    'addons/maxmega_report_addons/report/picking.rml',
    parser=maxmega_packing_order, header=False)
