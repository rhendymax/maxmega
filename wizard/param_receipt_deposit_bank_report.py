...
class param_receipt_deposit_bank_report(osv.osv_memory):
    _name = 'param.receipt.deposit.bank.report'
    _description = 'Param Receipt Deposit Bank Report '
    _columns = {
        ...
        'partner_ids' :fields.many2many('res.partner', 'report_receivable_deposit_customer_rel', 'report_id', 'partner_id', 'Customer', domain=[('customer','=',True)]),
        ...
        'journal_ids' :fields.many2many('account.journal', 'report_receivable_deposit_journal_rel', 'report_id', 'journal_id', 'Bank', domain=[('type','in',('bank','cash'))]),
    }
...
param_receipt_deposit_bank_report()
