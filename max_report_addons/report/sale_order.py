...
class maxmega_sale_order(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(maxmega_sale_order, self).__init__(cr, uid, name, context=context)
...
#         print str(name)
    ...
    def _get_description(self, l):
        description = ''
        description = ((l.product_id and l.product_id.default_code) or '' )+ '\n' + "CPN:"+ ((l.product_customer_id and l.product_customer_id.name) or '')
        return description
...
report_sxw.report_sxw(
    'report.max.sale.order',
    'sale.order',
    'addons/maxmega_report_addons/report/sale_order.rml',
    parser=maxmega_sale_order, header=False)
