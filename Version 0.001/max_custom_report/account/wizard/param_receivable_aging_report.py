...
class param_receivable_aging_report(osv.osv_memory):
    _name = 'param.receivable.aging.report'
    _description = 'Param Receivable Aging Report'
    _columns = {
    ...
    def generate(self, cr, uid, ids, context=None):
        ...
        datas['model'] = 'param.receivable.aging.report'
