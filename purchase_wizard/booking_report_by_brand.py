...
class booking_report_by_brand(osv.osv_memory):
    ...
    _description = 'Supplier Booking Report By Brand'
    _columns = {
...
#        code_to = form['partner_code_to']
        ...
        all_content_line = ''
        header = 'sep=;' + " \n"
        header += 'Supplier Booking Report By Brand' + " \n"
        ...
        header += 'INVENTORY KEY;COST US$;QUANTITY;TOTAL COST;PURCHASE ORDER DATE;SUPPLIER;PO NO' + " \n"
#INGAT
...
#                        rate = account_invoice_obj.browse(cr, uid, result['invoice_id']).cur_rate
                        ...
                        + str(result['part_name'] or '') + ";" + str(result['po_name'] or '') + "\n"
                        qty = result['qty'] or 1
                        total_qty += qty or 1
        ...
        filename = 'Supplier Booking Report By Brand.csv'
        ...
        return {
                'name':'Supplier Booking Report By Brand',
                'view_type': 'form',
                'view_mode': 'form',
