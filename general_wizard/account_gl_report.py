...
class maxmega_gl_report(osv.osv_memory):
    _name = 'maxmega.gl.report'
...
# 		print "::: accounts :::", acc_ids
		...
		model_data_ids = obj_model.search(cr,uid,[('model','=','ir.ui.view'),('name','=','maxmega_gl_result_data_view')])
		resource_id = obj_model.read(cr, uid, model_data_ids, fields=['res_id'])[0]['res_id']
		return {
		        'name':'General Ledger Report',
		        'view_type': 'form',
		        'view_mode': 'form',
		        'res_model': 'maxmega.gl.report',
