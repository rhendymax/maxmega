...
class purchase_journal_by_supplier_report(report_sxw.rml_parse):
    _name = 'purchase.journal.by.supplier.report'
...
#        raise osv.except_osv(_('Invalid action !'), _(' \'%s\' \'%s\'!') %(data['form']['partner_code_from'][0], data['form']['partner_code_from'][0]))
        return super(purchase_journal_by_supplier_report, self).set_context(objects, data, new_ids, report_type=report_type)
...
report_sxw.report_sxw('report.purchase.journal.by.supplier.report_landscape', 'account.invoice',
    'addons/max_custom_report/account/report/purchase_journal_by_supplier_report.rml', parser=purchase_journal_by_supplier_report, header="internal landscape")
