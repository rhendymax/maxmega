...
#        'account_ids': fields.many2many('account.account', string='Accounts', required=True, domain="[('type','!=','view')]"),
        ...
        'account_default_from':fields.many2one('account.account', 'Account From', domain=[], required=False),
        'account_default_to':fields.many2one('account.account', 'Account To', domain=[], required=False),
        'account_input_from': fields.char('Account From', size=128),
        'account_input_to': fields.char('Account To', size=128),
        'account_ids' :fields.many2many('account.account', 'report_gl_account_rel', 'report_id', 'account_id', 'Account', domain=[]),
