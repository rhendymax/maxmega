...
class param_sales_journal_by_customer_report(osv.osv_memory):
    _name = 'param.sales.journal.by.customer.report'
    _description = 'Param Sales Journal By Customer Report'
    _columns = {
        ...
        'partner_ids' :fields.many2many('res.partner', 'report_receivable_journal_cust_rel', 'report_id', 'partner_id', 'Customer', domain=[('customer','=',True)]),
    ...
    def create_vat(self, cr, uid, ids, context=None):
        ...
        datas['model'] = 'param.sales.journal.by.customer.report'
